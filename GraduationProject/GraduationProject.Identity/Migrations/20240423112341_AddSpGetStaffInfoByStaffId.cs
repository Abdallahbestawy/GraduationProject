...
{
    public partial class AddSpGetStaffInfoByStaffId : Migration
    {
            ...
            migrationBuilder.Sql(@"
                ...
                BEGIN
                    SELECT 
                        ...
                        Staffs.Street as StaffStreet,
                        Countrys.Id as StaffCountrysId,
                        Governorates.Id as StaffGovernoratesId,
                        Citys.Id as StaffCitysId,
                        Staffs.DateOfBirth,
                        Staffs.Gender,
                        Staffs.Nationality,
                        Staffs.PlaceOfBirth,
        ...
        {
            migrationBuilder.Sql("DROP PROCEDURE [dbo].[SpGetStaffInfoByStaffId]");
        }
    }
}
