...
namespace GraduationProject.Repository.Repository
{
    public class StudentSemesterAssessMethodRepository : GeneralRepository<StudentSemesterAssessMethod>, IStudentSemesterAssessMethodRepository
    {
        ...
        //    IQueryable<SpGetStudentSemesterAssessMethodsBySpecificCourseAndControlStatus> query = await _context.
        //        GetStudentSemesterAssessMethodsBySpecificCourseAndControlStatus(courseId, isControlStatus);
