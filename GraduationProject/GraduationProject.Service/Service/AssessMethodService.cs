    ...
    public class AssessMethodService : IAssessMethodService
    {
        ...
        public async Task<Response<int>> AddAssessMethodAsync(AssessMethodDto addAssessMethodDto)
        {
            try
            {
                ...
                return Response<int>
                    .ServerError("Error occured while adding Assess Method",
        ...
        public async Task<Response<IQueryable<AssessMethodDto>>> GetAssessMethodAsync()
        {
            try
            {
                ...
                if (!assessMethodEntities.Any())
                    return Response<IQueryable<AssessMethodDto>>.NoContent("No Assess Methods is exist");
            ...
            catch(Exception ex)
            {
                ...
                return Response<IQueryable<AssessMethodDto>>
                    .ServerError("Error occured while retrieving Assess Methods",
        ...
        public async Task<Response<AssessMethodDto>> GetAssessMethodByIdAsync(int assessMethodId)
        {
            ...
            catch (Exception ex)
            {
                ...
                return Response<AssessMethodDto>
                    .ServerError("Error occured while retrieving Assess Method",
        ...
        public async Task<Response<int>> UpdateAssessMethodAsync(AssessMethodDto updateAssessMethodDto)
        {
            try
            {
                ...
                return Response<int>
                    .ServerError("Error occured while updating Assess Method",
        ...
        public async Task<Response<int>> DeleteAssessMethodAsync(int assessMethodId)
        {
            try
            {
                ...
                return Response<int>
                    .ServerError("Error occured while deleting Assess Method",
